...
public class KnnQParserTest extends SolrTestCaseJ4 {
  ...
  public void byteKnnQueryWithSeedQuery_shouldPerformSeededKnnVectorQuery() {
    ...
    assertQ(
        req(
            ...
            "true"),
        "//result[@numFound='4']",
        "//str[@name='parsedquery'][.='SeededKnnVectorQuery(SeededKnnVectorQuery{seed=id:1 id:4 id:7 id:8 id:9, seedWeight=null, delegate=SolrKnnByteVectorQuery:vector_byte_encoding[2,...][4]})']");
  }
  ...
  public void knnQueryWithKnnSeedQuery_shouldPerformSeededKnnVectorQuery() {
    ...
    assertQ(
        req(
            ...
            "true"),
        "//result[@numFound='4']",
        "//str[@name='parsedquery'][.='SeededKnnVectorQuery(SeededKnnVectorQuery{seed=SolrKnnFloatVectorQuery:vector[0.1,...][4], seedWeight=null, delegate=SolrKnnFloatVectorQuery:vector[1.0,...][4]})']");
  }
  ...
  public void
    ...
    assertQ(
        ...
        // Verify that the final delegate is a SolrKnnFloatVectorQuery with the expected vector and
        // topK
        // value
        "//str[@name='parsedquery'][contains(.,'delegate=SolrKnnFloatVectorQuery:vector[1.0,...][4]')]");
  }
